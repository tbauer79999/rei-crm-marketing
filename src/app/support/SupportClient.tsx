...
export default function SupportClient() {
  ...
  return (
    <div className="min-h-screen bg-[#EAF7F9] flex items-center justify-center px-4">
      <div className="max-w-xl w-full bg-white p-8 rounded-lg shadow-sm shadow-blue-500/5">
        <h1 className="text-2xl font-semibold mb-4">Contact SurFox AI Support</h1>
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="w-full p-2 border border-[#E4E6E2] rounded mb-4"
            required
          />
