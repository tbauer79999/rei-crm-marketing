...
export default function EventsClient() {
  return (
    <div className="bg-[#F4F5F3] text-[#13171F]">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EAF7F9] border border-[#dCEEF1] mb-8">
              ...
              <span className="text-sm font-semibold text-[#0A7C8C]">For Event Marketers</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#13171F] mb-6 sm:mb-8 leading-[1.1] tracking-tight" style={{ fontFamily: 'var(--font-space-grotesk)' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="px-8 sm:px-10 py-3 sm:py-4 rounded-lg bg-[#13171F] text-white text-base font-semibold hover:bg-black transition inline-flex items-center gap-2"
              >
                Schedule a Demo
      ...
      <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-[#F4F5F3]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-8 rounded-2xl bg-white border border-[#E4E6E2] shadow-sm"
              >
          ...
          <div className="space-y-5">
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-5 p-6 rounded-xl border border-[#EDEEEB] bg-[#F4F5F3]"
              >
      ...
      <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-[#F4F5F3]">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <table className="w-full text-left rounded-2xl overflow-hidden border border-[#E4E6E2] shadow-sm">
              <thead>
                ...
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F4F5F3]'}>
                    ...
                    <td className="px-5 py-4 text-sm text-center">
                      {row.manual === false ? (
                        <XCircle className="w-5 h-5 text-[#8A92A0] mx-auto" />
                      ) : (
                    ...
                    <td className="px-5 py-4 text-sm text-center">
                      {row.email === false ? (
                        ...
                        <span className="text-[#8A92A0]">{row.email}</span>
                      )}
                    </td>
                    <td className="px-5 py-4 text-sm text-center bg-[#F4F5F3]">
                      {row.surfox === true ? (
                        <CheckCircle className="w-5 h-5 text-[#0A7C8C] mx-auto" />
                      ) : (
      ...
      <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-white">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-10 rounded-2xl border-2 border-[#0FB6C9]/30 bg-[#F4F5F3]"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EAF7F9] border border-[#dCEEF1] mb-6">
              <Zap className="w-4 h-4 text-[#0A7C8C]" />
              <span className="text-xs font-bold text-[#0A7C8C] uppercase tracking-wide">Built for every event</span>
            </div>
      ...
      <section className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-white text-[#13171F]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-8 sm:px-10 py-3 sm:py-4 rounded-lg bg-[#13171F] text-white font-semibold hover:bg-black transition inline-flex items-center gap-2"
              >
                Schedule a Demo
                <ArrowRight className="w-5 h-5" />
              </motion.a>
