        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-xl z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <Link href="/vision" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-cyan-50 hover:text-gray-900 transition-colors border-b border-gray-100">
                  Vision & Roadmap
                </Link>
                <Link href="/ai-principles" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-cyan-50 hover:text-gray-900 transition-colors border-b border-gray-100">
                  AI Principles
                </Link>
                <Link href="/newsroom" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-cyan-50 hover:text-gray-900 transition-colors">
                  Newsroom
                </Link>
              </div>
            </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200 animate-fade-in">
          <div className="px-4 py-6 space-y-4 max-h-[calc(100vh-4rem)] overflow-y-auto">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <Link href="/vision" className="block py-2 text-gray-700 hover:text-gray-900 transition-colors">Vision & Roadmap</Link>
              <Link href="/ai-principles" className="block py-2 text-gray-700 hover:text-gray-900 transition-colors">AI Principles</Link>
              <Link href="/newsroom" className="block py-2 text-gray-700 hover:text-gray-900 transition-colors">Newsroom</Link>
            </div>
