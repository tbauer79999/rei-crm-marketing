      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/#platform" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              Platform
            </Link>
            <Link href="/#intelligence" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              Messaging Intelligence
            </Link>
            <Link href="/#industries" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              Industries
            </Link>
            <Link href="/enterprise" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              Enterprise
            </Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-800/95 backdrop-blur-xl border-t border-purple-500/30">
          <div className="px-4 py-6 space-y-4">
            <Link href="/#platform" className="block text-gray-300 hover:text-white transition-colors text-sm font-medium">Platform</Link>
            <Link href="/#intelligence" className="block text-gray-300 hover:text-white transition-colors text-sm font-medium">Messaging Intelligence</Link>
            ...
            <Link href="/enterprise" className="block text-gray-300 hover:text-white transition-colors text-sm font-medium">Enterprise</Link>
            
            {/* Compare section for mobile */}
            <div className="border-t border-purple-500/30 pt-4">
              <div className="text-gray-300 text-sm font-medium mb-2">Compare</div>
