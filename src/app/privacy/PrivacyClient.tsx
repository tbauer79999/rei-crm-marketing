      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mb-16 gradient-bg/5 border-2 border-orange/20 rounded-2xl p-8"
          >
          ...
          >
            ...
            <div className="ml-16 space-y-3 text-white/60">
          ...
          >
            ...
            <div className="ml-16 space-y-4 text-white/60 leading-relaxed">
              <p>
