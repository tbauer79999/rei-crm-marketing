...
export default function EnterprisePage() {
  return (
    <div className="min-h-screen bg-[#F4F5F3] text-[#13171F]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-[#13171F] mb-4">Enterprise Solutions</h1>
          <p className="text-lg text-[#5A626E] max-w-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-white border border-[#E4E6E2] p-6 rounded-xl">
            <div className="flex items-center mb-4">
              <Users className="w-5 h-5 text-[#0A7C8C] mr-2" />
              <h2 className="text-xl font-semibold text-[#13171F]">Multi-Tenant Ready</h2>
            </div>
          ...
          <div className="bg-white border border-[#E4E6E2] p-6 rounded-xl">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#13171F]">Custom AI Behavior</h2>
            </div>
            <p className="text-[#5A626E]">
          ...
          <div className="bg-white border border-[#E4E6E2] p-6 rounded-xl">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#13171F]">Full Visibility</h2>
            </div>
            <p className="text-[#5A626E]">
          ...
          <div className="bg-white border border-[#E4E6E2] p-6 rounded-xl">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-[#13171F]">Dedicated Support</h2>
            </div>
            <p className="text-[#5A626E]">
        ...
        <div className="text-center mt-20">
          <h3 className="text-2xl font-bold text-[#13171F] mb-4">Talk to Sales</h3>
          <p className="text-[#5A626E] mb-6 max-w-xl mx-auto">
            Let us show you how SurFox AI can adapt to your enterprise sales model and boost lead-to-close efficiency at scale.
          </p>
          <a
            href="#"
            className="inline-block bg-[#13171F] text-white px-6 py-3 rounded-lg font-semibold hover:shadow-sm shadow-blue-500/5 shadow-blue-500/5 hover:shadow-purple-500/25 transition-all"
          >
