    ...
    <div className="sfx">
      ...
      <section style={{ paddingTop: 8 }}>
        <div className="wrap cta">
          <h2 className="disp">Pick a door: text, chat, or publish a number.</h2>
          <p>SurFox AI answers in seconds, qualifies, and books the call.</p>
          <a
