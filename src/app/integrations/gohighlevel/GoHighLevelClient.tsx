        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EAF7F9] border border-[#dCEEF1] mb-8">
              <LayoutDashboard className="w-4 h-4 text-[#0A7C8C]" />
              <span className="text-sm font-semibold text-[#0A7C8C]">GoHighLevel + SurFox AI</span>
            </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[#5A626E] mt-4 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <motion.div
              ...
              className="relative p-8 rounded-2xl border-2 border-blue-500/40 bg-[#F0F8F9] shadow-[0_0_40px_rgba(59,130,246,0.08)]"
            >
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#13171F] text-white">
                <Sparkles className="w-3.5 h-3.5" />
                <span className="text-xs font-bold uppercase tracking-wider">Recommended</span>
              </div>

              <div className="w-12 h-12 rounded-xl bg-[#EAF7F9] border border-blue-500/30 flex items-center justify-center mb-5 mt-2">
                <Webhook className="w-6 h-6 text-[#0A7C8C]" />
              </div>

              <h3 className="text-2xl font-bold text-[#13171F] mb-2">Native HighLevel Workflows</h3>
              <p className="text-[#0A7C8C] font-medium mb-6">Real-time. Free. Tag-based routing.</p>
              ...
              <ul className="space-y-3 mb-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-[#5A626E] leading-relaxed">{bullet}</span>
                  </li>
                ))}
              </ul>

              <p className="text-sm text-[#5A626E] leading-relaxed pt-4 border-t border-[#EDEEEB]">
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl border border-[#E4E6E2] bg-[#F4F5F3]/40"
            >
              <div className="w-12 h-12 rounded-xl bg-white/[0.04] border border-[#E4E6E2] flex items-center justify-center mb-5 mt-2">
                <Zap className="w-6 h-6 text-[#5A626E]" />
              </div>

              <h3 className="text-2xl font-bold text-[#13171F] mb-2">Zapier Templates</h3>
              <p className="text-[#5A626E] font-medium mb-6">One-click setup with pre-built Zaps.</p>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-white/[0.04] border border-[#E4E6E2] flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-between gap-2 px-5 py-3 rounded-lg border border-[#E4E6E2] text-[#13171F] text-sm font-semibold hover:bg-white/[0.04] hover:border-[#E4E6E2] transition"
                >
