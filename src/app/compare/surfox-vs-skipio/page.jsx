  ...
  const featureSets = [
    {
      ...
      icon: Brain,
      features: [
        { name: 'Conversation Handling', surfox: 'AI writes every message and handles responses automatically', skipio: 'You write drafts manually, then review every response' },
        { name: 'Conversation Memory', surfox: 'AI knows the full conversation history with each lead', skipio: 'No memory - treats every message as first contact' },
        { name: 'Learning Capability', surfox: 'AI learns your business and improves with every conversation', skipio: 'Same templates forever - no learning or improvement' },
        { name: 'Buying Signal Detection', surfox: 'AI reads when prospects are ready to buy and alerts you', skipio: 'You manually read every message to find hot leads' },
        { name: 'Context Understanding', surfox: 'AI reads between the lines and responds appropriately', skipio: 'Basic keyword triggers only - misses context and tone' }
      ]
    },
    {
      ...
      icon: Target,
      features: [
        { name: 'Hot Lead Identification', surfox: 'AI scores every lead and flags the ones ready to buy', skipio: 'You manually sort through all responses to find good ones' },
        { name: 'Qualification Process', surfox: 'AI asks the right questions and qualifies leads for you', skipio: 'You have to qualify every lead manually' },
        { name: 'Escalation Intelligence', surfox: 'AI alerts you only when prospects are sales-ready', skipio: 'You monitor everything - no intelligent escalation' },
        { name: 'Lead Prioritization', surfox: 'AI ranks leads by likelihood to close', skipio: 'All leads look the same - you decide priority manually' },
        { name: 'Appointment Quality', surfox: 'AI hands you leads that are motivated and qualified', skipio: 'You get raw responses - must figure out who to call' }
      ]
    },
    {
      ...
      icon: Zap,
      features: [
        { name: 'Conversation Adaptation', surfox: 'AI changes approach based on how each prospect responds', skipio: 'Same linear sequence for everyone regardless of responses' },
        { name: 'Timing Optimization', surfox: 'AI knows when each prospect is most likely to respond', skipio: 'Fixed schedules that ignore individual behavior patterns' },
        { name: 'Objection Handling', surfox: 'AI responds to concerns and keeps conversations moving forward', skipio: 'Basic auto-replies that often miss the point' },
        { name: 'Follow-up Management', surfox: 'AI ensures every lead gets the right follow-up at the right time', skipio: 'You manually manage all follow-ups and timing' },
    ...
    },
    {
      ...
      features: [
        ...
        { name: 'Pricing Model', surfox: 'All-inclusive $197/month subscription', skipio: 'Base fee plus per-message costs' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4">
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-start text-sm text-gray-700">
                  <Check className="w-5 h-5 mr-2 mt-0.5 text-orange flex-shrink-0" />
                  <span>You want AI to handle conversations for you</span>
                </div>
                <div className="flex items-start text-sm text-gray-700">
                  <Check className="w-5 h-5 mr-2 mt-0.5 text-orange flex-shrink-0" />
