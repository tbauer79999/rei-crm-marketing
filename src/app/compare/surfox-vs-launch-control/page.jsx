    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 font-sans text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center space-x-8 mb-12">
              ...
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-orange-600/50 rounded-2xl flex items-center justify-center">
                  <Rocket className="w-8 h-8 text-orange-400" />
                </div>
                <div className="text-left">
                  <div className="text-3xl font-bold text-gray-400">Launch Control</div>
            ...
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-gray-900/90 to-purple-900/90 backdrop-blur-xl rounded-2xl border border-purple-500/30 p-6 text-center shadow-2xl">
                <div className="text-3xl font-bold text-orange-400 mb-2">$197</div>
      ...
      <section className="relative py-20 bg-gradient-to-r from-purple-900/50 to-blue-900/50 backdrop-blur-xl border-y border-purple-500/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Launch Control Side */}
            <div className="bg-gradient-to-br from-orange-900/40 to-red-600/40 rounded-2xl border border-orange-400/30 p-8 backdrop-blur-sm">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-orange-600/50 rounded-xl flex items-center justify-center mr-4">
                  <Rocket className="w-6 h-6 text-orange-400" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-orange-300">Launch Control</h3>
                  <p className="text-orange-200">Manual Campaign Management</p>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-orange-900/40 border border-orange-400/30 rounded-xl">
            ...
            <div className="bg-gradient-to-br from-purple-900/40 to-cyan-900/40 rounded-2xl border-2 border-purple-400/50 p-8 backdrop-blur-sm shadow-lg shadow-purple-500/25">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-purple-200">AI-Powered Sales Rep</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-purple-900/40 border border-purple-400/30 rounded-xl p-4">
                  ...
                  <p className="text-sm text-purple-200">AI writes messages, handles replies, qualifies leads, escalates when ready. You focus on closing.</p>
                </div>
                ...
                <div className="bg-purple-900/40 border border-purple-400/30 rounded-xl p-4">
                  ...
                  <p className="text-sm text-purple-200">AI monitors 24/7, never misses a signal, escalates hot leads instantly with full context.</p>
                </div>
                ...
                <div className="bg-purple-900/40 border border-purple-400/30 rounded-xl p-4">
                  ...
                  <p className="text-sm text-purple-200">Never repeats messages, learns from every conversation, adapts tone per lead automatically.</p>
                </div>
              </div>
      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-gradient-to-br from-gray-900/60 to-black/60 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-xl">
              ...
              <div className="space-y-6">
                <div className="p-4 bg-orange-900/40 border border-orange-400/30 rounded-xl">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <div className="font-semibold text-orange-300">Launch Control Total Cost</div>
                      <div className="text-sm text-orange-200">Platform + manual labor</div>
                    </div>
                ...
                <div className="text-center p-4 bg-green-900/40 border border-green-400/30 rounded-xl">
                  <div className="text-2xl font-bold text-green-400">87% Cost Reduction</div>
                  <div className="text-sm text-green-300">by eliminating manual campaign work</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/60 to-black/60 border border-gray-700/50 rounded-2xl p-8 backdrop-blur-xl">
              ...
              <div className="space-y-6">
                <div className="p-4 bg-gray-800/40 border border-gray-600/30 rounded-xl">
                  <h4 className="font-semibold text-gray-300 mb-2">Launch Control Capabilities</h4>
                ...
                <div className="text-center p-4 bg-gradient-to-r from-purple-900/50 to-cyan-900/50 border border-purple-400/30 rounded-xl">
                  ...
                  <div className="text-sm text-purple-200">First-ever Sales Psychology AI vs manual templates</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-900/40 to-cyan-900/40 border border-purple-400/30 rounded-2xl p-8 text-center backdrop-blur-xl">
            <h3 className="text-2xl font-bold text-white mb-6">Daily Workflow Comparison</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-lg text-purple-200 mb-2">Launch Control Daily Work</div>
                <div className="text-3xl font-bold text-orange-400 mb-2">5+ hours</div>
                <div className="text-sm text-gray-400">Campaign setup + monitoring + replies</div>
              </div>
              <div className="text-center">
                <div className="text-lg text-purple-200 mb-2">vs</div>
                <div className="text-3xl font-bold text-purple-400 mb-2">35 minutes</div>
                <div className="text-sm text-purple-300">SurFox AI automation</div>
              </div>
              <div className="text-center">
                <div className="text-lg text-purple-200 mb-2">Time Saved</div>
                <div className="text-3xl font-bold text-green-400 mb-2">25+ hours</div>
                <div className="text-sm text-gray-400">per week with AI</div>
              </div>
            </div>
      ...
      <section id="cta" className="relative py-20 bg-gradient-to-br from-purple-900 via-blue-900 to-cyan-900">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="mt-12">
            <p className="text-sm text-gray-400 mb-4">Trusted by teams who upgraded from manual tools</p>
