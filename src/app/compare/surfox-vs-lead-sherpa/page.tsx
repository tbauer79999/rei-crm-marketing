...
import { ArrowRight, Check, X, Shield, Search, Clock, Sparkles, Award } from 'lucide-react';
import FeatureComparison from './LeadSherpaClient';
      ...
      <div className="bg-[#F4F5F3] text-[#13171F]">
          ...
          <div className="max-w-5xl mx-auto text-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
                ...
                <div className="flex items-center gap-3 p-4 rounded-2xl border-2 border-[#E4E6E2] bg-white">
                  <div className="w-12 h-12 rounded-xl bg-white/[0.06] flex items-center justify-center">
                    <Search className="w-6 h-6 text-[#8A92A0]" />
                  </div>
                  <div className="text-left">
                    <div className="text-2xl font-semibold text-[#5A626E]">Lead Sherpa</div>
                    <div className="text-sm text-[#8A92A0]">Skip Trace + Compliance</div>
                  </div>
                </div>
              </div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-[#5A626E] mb-4 max-w-3xl mx-auto leading-relaxed font-normal px-4">
                <strong className="text-[#13171F]">Lead Sherpa excels at finding contacts legally.</strong>
              </p>
              <p className="text-lg sm:text-xl md:text-2xl text-[#5A626E] mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed font-normal px-4">
                <strong className="text-[#0A7C8C]">SurFox AI excels at converting those contacts into sales.</strong>
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4">
                ...
                <div className="p-4 sm:p-6 rounded-2xl border-2 border-[#E4E6E2] bg-[#F4F5F3]">
                  <div className="text-2xl sm:text-3xl font-semibold text-[#0A7C8C] mb-2">3x</div>
                  <div className="text-sm text-[#5A626E]">More Appointments</div>
                  <div className="text-xs text-[#8A92A0] mt-1">vs basic messaging</div>
                </div>
                <div className="p-4 sm:p-6 rounded-2xl border-2 border-[#E4E6E2] bg-[#F4F5F3]">
                  <div className="text-2xl sm:text-3xl font-semibold text-[#0A7C8C] mb-2">24/7</div>
                  <div className="text-sm text-[#5A626E]">AI Working</div>
                  <div className="text-xs text-[#8A92A0] mt-1">vs business hours</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4">
              ...
              <div className="p-6 sm:p-8 rounded-2xl border-2 border-[#E4E6E2] bg-[#F4F5F3]">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#13171F]">Lead Sherpa</h3>
                    <p className="text-sm text-[#5A626E]">Data Acquisition Excellence</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 rounded-xl border border-[#E4E6E2] bg-white">
                    ...
                    <p className="text-sm text-[#5A626E]">&quot;I need to find property owners legally and stay TCPA compliant&quot;</p>
                  </div>
                ...
                <div className="p-4 rounded-xl border border-[#E4E6E2] bg-white">
                  <p className="text-sm text-[#5A626E]">
                    <strong className="text-[#13171F]">Best For:</strong> Real estate investors who need compliant contact acquisition
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8 rounded-2xl border-2 border-blue-500/30 bg-blue-500/5">
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 rounded-xl border border-[#dCEEF1] bg-[#F4F5F3]">
                    ...
                    <p className="text-sm text-[#5A626E]">&quot;I have contacts but my response rates suck and I&apos;m not closing enough deals&quot;</p>
                  </div>
                ...
                <div className="p-4 rounded-xl border border-[#dCEEF1] bg-[#F4F5F3]">
                  <p className="text-sm text-[#5A626E]">
                    <strong className="text-[#13171F]">Best For:</strong> Sales teams who have contacts but want 3x more qualified appointments
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4">
              ...
              <div className="p-6 sm:p-8 rounded-2xl border-2 border-red-500/20 bg-red-500/5">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-lg font-semibold text-[#13171F]">Lead Sherpa: Your Daily 4+ Hours</h3>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-3 rounded-lg border border-red-500/20 bg-[#F4F5F3]">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-xs font-medium text-[#5A626E]">8:00 AM - Morning Setup (45 mins)</span>
                    </div>
                    <p className="text-sm text-[#5A626E]">Review data, update templates, configure campaigns</p>
                  </div>

                  <div className="p-3 rounded-lg border border-red-500/20 bg-[#F4F5F3]">
                    <div className="flex items-center mb-2">
                      <Clock className="w-4 h-4 mr-2 text-[#5A626E]" />
                      <span className="text-xs font-medium text-[#5A626E]">10:00 AM - Response Management (2 hours)</span>
                    </div>
                  ...
                  <div className="p-3 rounded-lg border border-red-500/20 bg-[#F4F5F3]">
                    <div className="flex items-center mb-2">
                      <Clock className="w-4 h-4 mr-2 text-[#5A626E]" />
                      <span className="text-xs font-medium text-[#5A626E]">2:00 PM - Campaign Monitoring (1 hour)</span>
                    </div>
                    <p className="text-sm text-[#5A626E]">Check delivery rates, analyze engagement, update messaging</p>
                  </div>
                  ...
                  <div className="p-3 rounded-lg border border-red-500/20 bg-[#F4F5F3]">
                    ...
                    <p className="text-sm text-[#5A626E]">Manual follow-ups, schedule calls, update CRM</p>
                  </div>
                </div>
        ...
        <section className="py-20 sm:py-28 md:py-32 px-4 sm:px-6 md:px-8 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="p-8 rounded-2xl border-2 border-blue-500/30 bg-blue-500/5 text-center">
              <h3 className="text-2xl font-semibold text-[#13171F] mb-4">The Ultimate Combination</h3>
              <p className="text-lg text-[#5A626E] leading-relaxed max-w-3xl mx-auto mb-4">
                <strong className="text-[#13171F]">Smart strategy:</strong> Many successful teams use Lead Sherpa for compliant data acquisition, then SurFox AI for AI conversion. Best of both worlds.
              </p>
              <p className="text-base text-[#5A626E] max-w-2xl mx-auto">
        ...
        <section className="py-20 sm:py-28 md:py-32 px-4 sm:px-6 md:px-8 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4">
              <div className="p-6 sm:p-8 rounded-2xl border-2 border-[#E4E6E2] bg-[#F4F5F3]">
                <h3 className="text-xl font-semibold text-[#13171F] mb-4">Choose Lead Sherpa When:</h3>
