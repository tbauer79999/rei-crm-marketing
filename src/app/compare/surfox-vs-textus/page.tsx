          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'TextUs starts around $300 per month per user for basic plans and scales up for teams. SurFox starts at $197 per month and handles unlimited AI conversations. For teams doing high-volume outreach, SurFox is significantly more cost-effective.',
                },
              },
              {
                '@type': 'Question',
