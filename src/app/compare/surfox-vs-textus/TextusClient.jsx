...
export default function SurFoxVsTextUs() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "TextUs starts around $300 per month per user for basic plans and scales up for teams. SurFox starts at $147 per month and handles unlimited AI conversations. For teams doing high-volume outreach, SurFox is significantly more cost-effective."
    },
    {
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed font-normal px-4">
              <strong className="text-orange">SurFox delivers AI-powered conversations starting at $147, with Growth at $597 for learning AI.</strong>
            </p>
