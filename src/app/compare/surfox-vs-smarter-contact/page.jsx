    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 overflow-x-hidden">
      ...
      <section className="min-h-screen relative flex items-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          ></div>
          <div 
            className="absolute w-96 h-96 bg-gradient-to-r from-purple-600/15 to-pink-600/15 rounded-full blur-3xl"
            style={{
              bottom: '20%',
              left: '10%',
              transform: `translate(${mousePosition.x * -0.02}px, ${mousePosition.y * -0.02}px)`
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <div className="mb-8">
              <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gray-200 text-gray-700 border border-gray-300 mb-4">
              ...
              <div className="flex items-center justify-center space-x-4 mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-2xl font-bold text-gray-900">SurFox</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-2xl font-medium text-gray-600">Smarter Contact</span>
                </div>
              </div>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <br />
              <span className="text-gray-900">vs Mass Blasting</span>
            </h1>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              SurFox uses AI to have <strong className="text-gray-800">real conversations</strong> that close 50 actual deals. See exactly why SurFox beats traditional messaging platforms.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-white/80 border border-emerald-200 rounded-xl p-6 text-center shadow-sm">
                <div className="text-3xl font-bold text-emerald-600 mb-2">5.2x</div>
                <div className="text-sm text-gray-600">Higher Conversion Rate</div>
                <div className="text-xs text-gray-500 mt-2">vs traditional messaging</div>
              </div>
              <div className="bg-white/80 border border-blue-200 rounded-xl p-6 text-center shadow-sm">
                <div className="text-3xl font-bold text-blue-600 mb-2">94%</div>
                <div className="text-sm text-gray-600">Lead Scoring Accuracy</div>
                <div className="text-xs text-gray-500 mt-2">AI identifies hot prospects</div>
              </div>
              <div className="bg-white/80 border border-purple-200 rounded-xl p-6 text-center shadow-sm">
                ...
                <div className="text-xs text-gray-500 mt-2">vs 1-2 hours for others</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-red-600">Smarter Contact</h3>
                  <p className="text-gray-600">Mass Messaging Approach</p>
                </div>
              </div>
              
              <div className="space-y-4 mb-8">
                <div className="bg-red-100 border border-red-200 rounded-lg p-4">
                  <h4 className="font-semibold text-red-700 mb-2">The Strategy:</h4>
                  <p className="text-sm text-red-800">"Blast everyone with the same message and see who responds"</p>
                </div>
                
                <div className="space-y-3">
                  <div className="flex items-start text-red-700">
                    <X className="w-5 h-5 mr-3 mt-0.5 text-red-500 flex-shrink-0" />
              ...
              <div className="bg-red-100 border border-red-200 rounded-lg p-4">
                <h4 className="font-semibold text-red-700 mb-2">Best For:</h4>
                <p className="text-sm text-red-800">Teams that want to send high volumes and manually filter responses</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-8 ring-1 ring-blue-200">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700">AI Conversation Approach</p>
                </div>
              </div>
              
              <div className="space-y-4 mb-8">
                <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-700 mb-2">The Strategy:</h4>
                  <p className="text-sm text-blue-800">"Have AI conversations that feel human and deliver qualified leads"</p>
                </div>
                
                <div className="space-y-3">
                  <div className="flex items-start text-blue-700">
                    <Check className="w-5 h-5 mr-3 mt-0.5 text-blue-600 flex-shrink-0" />
              ...
              <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-800">Teams that want AI to qualify leads and only engage when prospects are ready to buy</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-200 border border-red-200 rounded-2xl p-6">
              <div className="flex items-center mb-6">
                <div className="w-8 h-8 bg-gray-300 rounded-lg flex items-center justify-center mr-3">
                  <MessageSquare className="w-4 h-4 text-gray-600" />
                </div>
                <h3 className="text-lg font-semibold text-red-600">Smarter Contact Approach</h3>
              </div>
              
              <div className="space-y-4 mb-6">
                <div className="bg-gray-300 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-gray-600 rounded-full mr-2"></div>
                    <span className="text-gray-600 text-xs">Day 1 - Mass Blast</span>
                  </div>
                  <p className="text-gray-700">"Hi [NAME], are you interested in selling your house?"</p>
                </div>
                ...
                <div className="bg-gray-300 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-gray-600 rounded-full mr-2"></div>
                    <span className="text-gray-600 text-xs">Day 4 - Same Template</span>
                  </div>
                  <p className="text-gray-700">"Hi [NAME], are you interested in selling your house?"</p>
                </div>
                ...
                <div className="bg-gray-300 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-gray-600 rounded-full mr-2"></div>
                    <span className="text-gray-600 text-xs">Day 11 - Final Blast</span>
                  </div>
                  <p className="text-gray-700">"Hi [NAME], are you interested in selling your house?"</p>
                </div>
              </div>
              ...
              <div className="bg-red-100 border border-red-200 rounded-lg p-4 text-center">
                ...
                <p className="text-red-700 font-medium">Result: Lead Lost</p>
                <p className="text-red-600 text-sm">Marked as spam, no engagement</p>
              </div>
            </div>

            {/* SurFox AI Conversation */}
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-6 ring-1 ring-blue-200">
              <div className="flex items-center mb-6">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mr-3">
                  <Brain className="w-4 h-4 text-white" />
                </div>
                <h3 className="text-lg font-semibold text-blue-600">SurFox AI Approach</h3>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-blue-100 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-blue-600 text-xs">Day 1 - AI Opening</span>
                  </div>
                  <p className="text-blue-800">"Hey Sarah — wasn't sure if this was still your number. If you're still thinking about selling, I can keep it simple for you."</p>
                </div>
                ...
                <div className="bg-blue-100 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                    <span className="text-blue-600 text-xs">Day 4 - AI Follow-up</span>
                  </div>
                  <p className="text-blue-800">"Just checking in — totally fine if not the right time. Market's been pretty good for sellers lately."</p>
                </div>
                
                <div className="bg-emerald-100 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-emerald-600 rounded-full mr-2"></div>
                    <span className="text-emerald-600 text-xs">Day 5 - Lead Response</span>
                  </div>
                  <p className="text-emerald-800">"Yeah I might be. What kind of offers are you seeing?"</p>
                </div>
                
                <div className="bg-blue-100 rounded-lg p-3 text-sm">
                  <div className="flex items-center mb-2">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mr-2"></div>
                    <span className="text-blue-600 text-xs">AI Response</span>
                  </div>
                  <p className="text-blue-800">"Great question! Most of my sellers in your area have been pleasantly surprised. Want me to pull some recent comps for your street?"</p>
                </div>
              </div>
              ...
              <div className="bg-emerald-100 border border-emerald-200 rounded-lg p-4 text-center">
                ...
                <p className="text-emerald-700 font-medium">Result: Hot Lead Ready!</p>
                <p className="text-emerald-600 text-sm">AI flags for immediate handoff</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-12 bg-gray-100 border-b border-gray-200">
              ...
              <div className="col-span-3 p-4 text-center border-l border-gray-200">
                <div className="flex items-center justify-center">
                  ...
                  <span className="font-medium text-gray-600">Smarter Contact</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-200 border border-red-200 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                <div className="w-10 h-10 bg-gray-300 rounded-xl flex items-center justify-center mr-4">
                  <MessageSquare className="w-5 h-5 text-gray-600" />
                </div>
                <h3 className="text-xl font-bold text-red-600">Smarter Contact Results</h3>
              </div>
              
              <div className="space-y-6">
                <div className="bg-red-100 border border-red-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-red-600 mb-1">~2-5%</div>
                  <div className="text-sm text-red-700">Response Rate</div>
                  <div className="text-xs text-red-600 mt-1">High spam risk hurts deliverability</div>
                </div>
                
                <div className="bg-red-100 border border-red-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-red-600 mb-1">Manual</div>
                  <div className="text-sm text-red-700">Lead Qualification</div>
                  <div className="text-xs text-red-600 mt-1">You sort through every response</div>
                </div>
                
                <div className="bg-red-100 border border-red-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-red-600 mb-1">1-2 hrs</div>
                  <div className="text-sm text-red-700">Setup Time</div>
                  <div className="text-xs text-red-600 mt-1">Plus ongoing template management</div>
                </div>
              </div>
              
              <div className="mt-8 p-4 bg-red-100 border border-red-200 rounded-lg">
                <h4 className="font-semibold text-red-700 mb-2">Typical Outcome:</h4>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-8 ring-1 ring-blue-200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-blue-600">SurFox AI Results</h3>
              </div>
              
              <div className="space-y-6">
                <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-1">12-18%</div>
                  <div className="text-sm text-blue-700">Engagement Rate</div>
                  <div className="text-xs text-blue-600 mt-1">Natural conversations reduce spam flags</div>
                </div>
                
                <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-1">AI-Driven</div>
                  <div className="text-sm text-blue-700">Lead Qualification</div>
                  <div className="text-xs text-blue-600 mt-1">Only see prospects ready to buy</div>
                </div>
                
                <div className="bg-blue-100 border border-blue-200 rounded-lg p-4">
                  <div className="text-2xl font-bold text-blue-600 mb-1">15 min</div>
                  <div className="text-sm text-blue-700">Setup Time</div>
                  <div className="text-xs text-blue-600 mt-1">AI handles everything after upload</div>
                </div>
              </div>
              
              <div className="mt-8 p-4 bg-blue-100 border border-blue-200 rounded-lg">
                <h4 className="font-semibold text-blue-700 mb-2">Typical Outcome:</h4>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200 rounded-2xl p-8 max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold text-emerald-700 mb-4">Bottom Line ROI Comparison</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center">
                  <div className="text-lg text-gray-600 mb-2">Smarter Contact</div>
                  <div className="text-3xl font-bold text-red-600 mb-2">1-3 deals</div>
                  <div className="text-sm text-gray-500">per 1,000 leads</div>
                </div>
                <div className="text-center">
                  <div className="text-lg text-gray-700 mb-2">SurFox AI</div>
                  <div className="text-3xl font-bold text-emerald-600 mb-2">15-25 deals</div>
                  <div className="text-sm text-gray-600">per 1,000 leads</div>
                </div>
              </div>
              <div className="mt-6 text-center">
                <span className="text-2xl font-bold text-emerald-700">5-8x Better Results</span>
                <span className="text-gray-600 ml-2">with SurFox AI</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Easy Data Import</h3>
            ...
            <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">AI Training Included</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">White-Glove Onboarding</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="#demo" className="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all">
      ...
      <section id="cta" className="py-20 bg-gray-100 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            <strong className="text-gray-800">14-day free trial.</strong> No setup fees. See results in your first week.
          </p>
