...
export default function SparaClient() {
  const comparisonData = [
    ...
    { factor: 'Pricing', surfox: '$197-$1,997/mo', spara: 'Enterprise contracts (unlisted)' },
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <div className="flex items-center gap-3 p-4 rounded-2xl border-2 border-orange bg-orange/5">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Outbound SMS</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl border-2 border-gray-200 bg-gray-50">
                ...
                <div className="text-left">
                  <div className="text-2xl font-semibold text-gray-600">Spara</div>
                  <div className="text-sm text-gray-500">Inbound Chat AI</div>
                </div>
              </div>
            </div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-4 max-w-3xl mx-auto leading-relaxed font-normal px-4">
              <strong className="text-navy">Spara handles inbound website visitors.</strong>
            </p>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed font-normal px-4">
              <strong className="text-orange">SurFox qualifies your outbound lead lists via SMS.</strong>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-4">
              <div className="p-4 sm:p-6 rounded-2xl border-2 border-gray-200 bg-white">
                <div className="text-2xl sm:text-3xl font-semibold text-orange mb-2">98%</div>
                <div className="text-sm text-gray-600">SMS Open Rate</div>
                <div className="text-xs text-gray-400 mt-1">vs 20% email</div>
              </div>
              <div className="p-4 sm:p-6 rounded-2xl border-2 border-gray-200 bg-white">
                <div className="text-2xl sm:text-3xl font-semibold text-orange mb-2">45%</div>
              ...
              <div className="p-4 sm:p-6 rounded-2xl border-2 border-gray-200 bg-white">
                ...
                <div className="text-xs text-gray-400 mt-1">not weeks</div>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 px-4">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-navy">Spara</h3>
                  <p className="text-sm text-gray-600">Inbound Website AI SDR</p>
                </div>
              </div>

              <div className="p-4 rounded-xl border border-gray-200 bg-gray-50 mb-6">
                <h4 className="font-semibold text-navy mb-2 text-sm">How It Works:</h4>
                <p className="text-sm text-gray-700">Spara engages visitors who come to your website through chat widget, email, and voice. It's an AI SDR for your inbound marketing motion.</p>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Outbound SMS Lead Qualification</p>
                </div>
              </div>

              <div className="p-4 rounded-xl border border-orange/20 bg-white mb-6">
                <h4 className="font-semibold text-navy mb-2 text-sm">How It Works:</h4>
                <p className="text-sm text-gray-700">SurFox proactively reaches out to YOUR lead lists via SMS. Upload cold leads, and AI qualifies them automatically. Your team only talks to hot prospects.</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start text-sm text-gray-700">
                  <Check className="w-5 h-5 mr-2 mt-0.5 text-orange flex-shrink-0" />
                  <span>SMB-friendly pricing starting at $197/mo</span>
                </div>
                <div className="flex items-start text-sm text-gray-700">
                  <Check className="w-5 h-5 mr-2 mt-0.5 text-orange flex-shrink-0" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="px-4 overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="text-left p-4 bg-gray-50 border-b-2 border-gray-200 font-semibold text-navy">Factor</th>
                  <th className="text-left p-4 bg-orange/10 border-b-2 border-orange/20 font-semibold text-orange">SurFox AI</th>
                  <th className="text-left p-4 bg-gray-50 border-b-2 border-gray-200 font-semibold text-gray-600">Spara</th>
                </tr>
              </thead>
              <tbody>
                {comparisonData.map((row, index) => (
                  ...
                  >
                    <td className="p-4 font-medium text-navy bg-gray-50">{row.factor}</td>
                    <td className="p-4 text-gray-700 bg-orange/5">{row.surfox}</td>
                    <td className="p-4 text-gray-600 bg-gray-50">{row.spara}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-20 sm:py-28 md:py-32 px-4 sm:px-6 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4">
            ...
            >
              <div className="flex items-center mb-6">
                <Smartphone className="w-8 h-8 text-orange mr-3" />
                <h3 className="text-2xl font-semibold text-navy">When to Choose SurFox</h3>
              </div>

              <div className="space-y-4">
                <div className="flex items-start text-gray-700">
                  <Check className="w-5 h-5 mr-3 mt-0.5 text-orange flex-shrink-0" />
              ...
              <div className="mt-6 p-4 rounded-xl bg-white border border-orange/20">
                <p className="text-sm text-gray-700">
                  <strong className="text-navy">Bottom line:</strong> SurFox is for teams with lead lists but no time to text them all. AI does the outreach, you do the closing.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-6">
                <Globe className="w-8 h-8 text-gray-500 mr-3" />
                <h3 className="text-2xl font-semibold text-navy">When to Choose Spara</h3>
              </div>

              <div className="space-y-4">
                <div className="flex items-start text-gray-700">
                  <Check className="w-5 h-5 mr-3 mt-0.5 text-green-600 flex-shrink-0" />
              ...
              <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-200">
                <p className="text-sm text-gray-700">
                  <strong className="text-navy">Bottom line:</strong> Spara is for companies with heavy inbound web traffic who want AI to handle initial visitor engagement.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-block px-4 py-2 rounded-full bg-green-100 border border-green-200 mb-6">
              <span className="text-sm font-semibold text-green-700">COMPLEMENTARY TOOLS</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed px-4">
              <strong className="text-navy">Yes!</strong> Spara handles your website visitors, SurFox works your outbound lists. Different channels, different use cases, complementary tools.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
              <div className="p-6 rounded-2xl border-2 border-gray-200 bg-gray-50">
                <Globe className="w-10 h-10 text-gray-500 mx-auto mb-4" />
                <h4 className="font-semibold text-navy mb-2">Spara Handles</h4>
                <p className="text-sm text-gray-600">Website visitors who find you through marketing, SEO, ads</p>
              </div>
              <div className="p-6 rounded-2xl border-2 border-orange bg-orange/5">
                <Smartphone className="w-10 h-10 text-orange mx-auto mb-4" />
                <h4 className="font-semibold text-navy mb-2">SurFox Handles</h4>
                <p className="text-sm text-gray-600">Your lead lists - purchased, aged, events, any outbound source</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-navy mb-2">SMS Open Rate</h4>
              <p className="text-sm text-gray-600">vs 20% for email. Your message actually gets seen.</p>
            </motion.div>
            ...
            >
              ...
              <h4 className="font-semibold text-navy mb-2">Response Rate</h4>
              <p className="text-sm text-gray-600">People actually text back - they don't respond to chatbots the same way.</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl border-2 border-orange bg-orange/5 text-center"
            >
              <MessageSquare className="w-10 h-10 text-orange mx-auto mb-2" />
              <h4 className="font-semibold text-navy mb-2">Feels Personal</h4>
              <p className="text-sm text-gray-600">SMS feels personal, not corporate. It's how people actually communicate.</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl border-2 border-orange bg-orange/5 text-center"
            >
              <Zap className="w-10 h-10 text-orange mx-auto mb-2" />
              <h4 className="font-semibold text-navy mb-2">Proactive</h4>
              <p className="text-sm text-gray-600">Don't wait for leads to visit your site. Reach out to them first.</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 px-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.05 }}
                className="p-4 rounded-2xl border-2 border-gray-200 bg-gray-50 text-center"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-10 sm:mb-12 leading-relaxed px-4 max-w-3xl mx-auto">
              Upload your leads, let SurFox AI qualify them via SMS, your team only talks to hot prospects. <strong className="text-navy">30-day money back guarantee.</strong>
            </p>

            <p className="text-base text-gray-500 mb-8 max-w-2xl mx-auto">
              Plans start at $197/month. Self-serve setup - live in minutes.
            </p>
